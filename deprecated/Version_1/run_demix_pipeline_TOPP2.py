...
# MSGF+ Excutable
apars.add_argument('-msgf', default=os.path.join(os.path.dirname(sys.argv[0]), 'MSGFPlus', 'MSGFPlus.jar')) 
...
''' % (urllib.pathname2url(args.mzml), urllib.pathname2url(args.db), urllib.pathname2url(args.msgf))
